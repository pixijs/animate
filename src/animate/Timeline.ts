...
class Timeline extends Array
{
     ...
     */
    addTween(instance: PIXI.DisplayObject, properties: Object, startFrame: number, duration: number, ease: Function): void
    {
    ...
    getPropFromShorthand(target: PIXI.DisplayObject, prop: string): number|boolean|PIXI.Graphics|PIXI.Sprite
    {
    	switch (prop)
    	{
    		case "x":
