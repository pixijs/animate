const data = {
    ...
    totalFrames: 3,
	assets: {
        "tween_nested_movieclip": "images/tween_nested_movieclip.shapes.json"
    },
	lib: {},
	shapes: {},
	textures: {},
    ...
    constructor(mode) {
        ...
        const instance1 = new Graphics()
            .drawCommands(data.shapes.tween_nested_movieclip[0]);
    ...
    data.lib.Symbol_4 = class extends MovieClip {
    constructor() {
        super({
            duration: 3
        });
    ...
    data.lib.tween_nested_movieclip = class extends MovieClip {
    constructor() {
        super({
            duration: 3,
            framerate: 24
        });
        const instance1 = new data.lib.Symbol_4()
            .setTransform(16.45, 15);
        this.addTimedChild(instance1);
    }
    }

    data.stage = data.lib.tween_nested_movieclip;
